                            ...
                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                <?php if(!empty($payments)): ?>
                                    ...
                                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
                                        ...
                                        <td class="py-4 px-6">
                                            <div class="flex items-center gap-3">
                                                <div class="font-semibold text-dark dark:text-white">
                                                    ...
                                                    <span class="block font-normal text-xs text-gray-500"><?= esc($payment['vendor_email']) ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="py-4 px-6">
                                            ...
                                            ?>
                                            <span class="px-3 py-1 <?= $statusClass ?> rounded-md text-xs font-semibold uppercase">
                                                <?= $payment['status'] ?>
                                            </span>
                                        </td>
                                        <td class="py-4 px-6 text-gray-500">
                                            <div class="text-xs">
                                                <div class="font-semibold text-dark dark:text-white">TXN: <?= esc($payment['txn_id']) ?></div>
                                                <div>Ref: <?= esc($payment['reference_no']) ?></div>
                                            </div>
                                        </td>
                                        <td class="py-4 px-6 text-gray-500">
                                ...
                                <?php else: ?>
                                    <tr class="bg-white dark:bg-gray-800">
                                        <td colspan="6" class="py-4 px-6 text-center text-gray-500">No transactions found.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
